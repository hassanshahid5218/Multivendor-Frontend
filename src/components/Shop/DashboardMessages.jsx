...
const ENDPOINT = "https://multivendor-socket-one.vercel.app/";
...
const DashboardMessages = () => {
  ...
  useEffect(() => {
    ...
    return () => {
        socketId.current.off("getMessage");
    };
    }, []);

    useEffect(() => {
  socketId.current.on("getConversationUpdate", (data) => {
    setConversations((prev) =>
      prev.map((conv) =>
        ...
        return () => {
         socketId.current.off("getConversationUpdate");
        };
    }, []);
